        ...
        <div className=''> 
          <form className='flex items-center justify-center flex-col mt-4'>
              <div className="flex items-start justify-center flex-col mt-4">
                  ...
                  <input className='w-[80%] border-slate-400 sm:w-80' type="email" placeholder='Your email address' name="email"/>
              </div>
              <div className="flex items-start justify-center flex-col mt-2">
                  <label className='font-semibold' for="password">Enter your password:</label>
                  <input className='w-[80%] border-slate-400 sm:w-80' type="password" placeholder='Your password' name='password'/>
              </div>
              <div className="w-full mt-2">
                <input type="checkbox" />
                <p className="ml-2 inline-block">Remember me</p>
              </div>
                <button className="account__button w-[80%] p-4 mt-4 rounded-xl bg-slate-800 text-white sm:w-80">Login</button>
                <br/>
